 ...
 * @param customerId Customer's ID generated by Stripe
 * @param priceId Price ID generate by Stripe
 * @returns Checkout
 */
 ...
 * @param email Email address of potential new User
 * @returns Customer
 */
 ...
 * @param customerId Customer's ID generated by Stripe
 */
export const createTrial = async (customerId: string) => {
 ...
 */
export const updateAccountEmail = async (customerId: string, email: string) => {
