...
Don't waste time reinventing the wheel, TAKEOFF handles user authentication for you. In addition, TAKEOFF provides functions to protect content from unauthenticated users or easily use a <Link href="/docs/content-protection"><a>paywall</a></Link>.
...
TAKEOFF projects using Chakra UI, daisyUI, or Tailwind CSS come automatically equipped with <Link href="/docs/dark-mode"><a>dark mode</a></Link>.
